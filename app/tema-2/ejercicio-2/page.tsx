...
export default function Ejercicio2() {
  return (
    <ExerciseLayout
      tema={2}
      exerciseNumber={2}
      title="Minimo CMe a Largo Plazo"
      difficulty="Medio-Alto"
      category="Costes LP"
      statement={
        <div className="space-y-2">
          <p>
            Suponga que la funcion de costes a largo plazo de una empresa que
          ...
          <p>
            ...
            fijo, con funcion de costes:
          </p>
          <FormulaDisplay math="C^c(x, \bar{K}) = 0.5x^3 - 4x^2 + (20 - \bar{K})x + 2.5\bar{K}^2" />
          <ol className="list-[lower-alpha] pl-5 space-y-1">
            <li>
              Determine el nivel de produccion que minimiza el CMe a LP y el
              minimo de los costes medios. Compruebe que CMg = CMe en ese
              punto.
            </li>
            <li>
              Calcule el nivel optimo de K asociado a ese nivel de produccion.
            </li>
          </ol>
        </div>
      }
    ...
    >
      ...
      >
        <Card className="bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-800">
          <CardContent className="p-3 sm:p-4 text-sm space-y-2">
            ...
            <p>
              A <strong>corto plazo</strong>, la empresa tiene una fabrica
              (capital K) de tamano fijo. Solo puede ajustar el trabajo (L).
              Esto limita su eficiencia.
            </p>
            <p>
              A <strong>largo plazo</strong>, puede elegir el tamano optimo de
              la fabrica. La curva de costes a LP es la{" "}
              <strong>envolvente</strong> de todas las curvas de CP: para cada
              nivel de produccion, elige el K que minimiza el coste.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gray-50 dark:bg-gray-800 border mt-3">
          <CardContent className="p-3 sm:p-4 text-sm space-y-2">
            <p className="font-semibold">Analogia: Elegir el tamano de tu piso</p>
            <p className="text-muted-foreground">
              Si vives solo, un estudio te basta (K pequeno). Si tienes
              familia, necesitas mas habitaciones (K grande). Si vivieras en un
              estudio con 5 personas, serian &laquo;ineficientes&raquo; (coste
              alto por persona). El &laquo;largo plazo&raquo; es cuando puedes
              mudarte y elegir el tamano ideal para tu situacion.
            </p>
          </CardContent>
        </Card>
      </StepCard>
      ...
      >
        <Card className="bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-800">
          <CardContent className="p-3 text-sm">
            <p className="text-blue-800 dark:text-blue-200">
              <strong>Estrategia:</strong> El minimo de CMe se encuentra donde
              su derivada se anula, o equivalentemente, donde CMg = CMe. Vamos
              a usar el primer metodo y verificar con el segundo.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-emerald-50 dark:bg-emerald-950/20 border-emerald-200 dark:border-emerald-800 mt-3">
          <CardContent className="p-3 sm:p-4 text-sm space-y-2">
            <p className="font-semibold text-emerald-800 dark:text-emerald-200">
              Metodo 1: Derivar CMeL e igualar a cero
            </p>
            <FormulaDisplay math="CMeL(x) = 0.5x^2 - 4.1x + 20" />
        ...
        <Card className="bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-800 mt-3">
          <CardContent className="p-3 text-sm space-y-1">
            ...
            <p className="text-muted-foreground">
              El nivel de produccion <InlineMath math="x^* = 4.1" /> es el
              punto de <strong>maxima eficiencia</strong> a largo plazo. En
              este punto, cada unidad cuesta en promedio{" "}
              <strong>11.595 euros</strong>. Producir menos o mas unidades
              implicaria un coste medio superior.
            </p>
          </CardContent>
        </Card>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mt-2">
          <ResultCard label="Produccion optima LP" value="x* = 4.1" />
          <ResultCard label="Minimo CMeL" value="11.595" />
        </div>
      </StepCard>
      ...
      >
        <Card className="bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-800">
          <CardContent className="p-3 text-sm space-y-1">
            <p className="font-semibold text-blue-800 dark:text-blue-200">
              ¿Como encontramos el K optimo?
            </p>
            <p className="text-muted-foreground">
              A largo plazo, la empresa elige K para minimizar costes. Esto
              significa que la funcion de costes a LP es el resultado de
              optimizar K en la funcion de CP. Por tanto, en el optimo, los
        ...
        <Card className="bg-emerald-50 dark:bg-emerald-950/20 border-emerald-200 dark:border-emerald-800 mt-2">
          <CardContent className="p-3 sm:p-4 text-sm space-y-2">
            <p className="font-semibold text-emerald-800 dark:text-emerald-200">
              Metodo: Minimizar Cc respecto a K
            </p>
            <p>
              El K optimo para cada nivel de x se obtiene minimizando{" "}
            ...
            <Card className="bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-800">
              <CardContent className="p-2 text-sm">
                <p className="text-blue-800 dark:text-blue-200">
                  Esto tiene sentido: a mas produccion, mas capital necesitas.
                  La relacion es lineal: por cada 5 unidades de produccion, 1
                  unidad de capital.
                </p>
              </CardContent>
            </Card>
        ...
        <Card className="bg-emerald-50 dark:bg-emerald-950/20 border-emerald-200 dark:border-emerald-800 mt-2">
          <CardContent className="p-3 sm:p-4 text-sm space-y-2">
            <p className="font-semibold text-emerald-800 dark:text-emerald-200">
              Verificacion: Cc(4.1, 0.82) = CL(4.1)
            </p>
        ...
        <ResultCard label="Capital optimo" value="K* = 0.82" />
      </StepCard>
      ...
      >
        <Card className="bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-800">
          <CardContent className="p-3 text-sm space-y-1">
            <p className="font-semibold text-blue-800 dark:text-blue-200">
              ¿Por que el CMe CP siempre esta por encima del CMe LP?
            </p>
            <p className="text-muted-foreground">
        ...
        <Card className="bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-800 mt-2">
          <CardContent className="p-3 text-sm space-y-1">
            ...
            <p className="text-muted-foreground">
              ...
              de todas las curvas de CMe a CP. Cada curva a CP (lineas
              discontinuas) corresponde a un tamano de fabrica distinto. El
              punto rojo marca donde la curva{" "}
              <InlineMath math="CMeCP(K^* = 0.82)" /> toca la envolvente: es el
              minimo absoluto de costes medios.
            </p>
          </CardContent>
        </Card>
      </StepCard>
